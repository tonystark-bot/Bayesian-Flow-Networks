"""
MinGPT but without the causal mask
"""
...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.transformer = nn.ModuleDict(
            dict(
                wte=nn.Linear(
                    config.vocab_size + 1, config.n_embd, bias=False
                ),  # use a linear layer instead of an embedding here
    ...
    def forward(self, input_, targets=None):
